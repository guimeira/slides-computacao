...
\begin{frame}{Máquinas de Turing}
	\begin{block}{Definição}
		...
		\begin{itemize}
			...
			\item $\delta: Q \times \Gamma \to Q \times \Gamma \times \{L,R\}$ é a função de transição
...
\begin{frame}{Máquinas de Turing}
	...
	\begin{itemize}
		\item $Q = \{q_{1}, q_{2}, q_{3}, q_{4}, q_{5}, q_{6}, q_{7}, q_{8}, q_{aceita}, q_{rejeita}\}$
		\item $\Sigma = \{0, 1, \#\}$
